...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/registration') {
            return array (  '_controller' => 'Ecommerce\\AccountBundle\\Controller\\AuthController::registrationAction',  '_route' => 'ecommerce_account_registration',);
        }

        // ecommerce_account_deconnexion
        if ($pathinfo === '/deconnexion') {
            return array (  '_controller' => 'Ecommerce\\AccountBundle\\Controller\\AuthController::deconnexionAction',  '_route' => 'ecommerce_account_deconnexion',);
        }

        // home_categories
        if ($pathinfo === '/categories') {
            return array (  '_controller' => 'Ecommerce\\ProductBundle\\Controller\\IndexController::indexAction',  '_route' => 'home_categories',);
        }
